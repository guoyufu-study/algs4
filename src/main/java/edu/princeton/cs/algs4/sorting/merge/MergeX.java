...
/**
 * {@code MergeX} 类提供了使用优化版本的mergesort对数组进行排序的静态方法。
 * 
 * <p>
 * 在最坏的情况下，此实现需要花费 &Theta;(<em>n</em> log <em>n</em>)
 * 时间来对长度为n的数组进行排序（假设比较需要固定的时间）。
 * 
 * <p>
 * 有关其他文档，请参见 Robert Sedgewick and Kevin Wayne 撰写的 <i>第4版算法</i>
 * <a href="https://algs4.cs.princeton.edu/22elementary">2.2节</a>。
 * 
 * <p>
 * The {@code MergeX} class provides static methods for sorting an array using
 * an optimized version of mergesort.
 * <p>
 * In the worst case, this implementation takes &Theta;(<em>n</em> log
 * <em>n</em>) time to sort an array of length <em>n</em> (assuming comparisons
 * take constant time).
 * <p>
